...
\chapter{Universal Dependency Parsing with a General Transition-Based DAG Parser (Published in CoNLL 2018 Shared Task)}\label{udst2018}
...
\end{subfigure}}
\fbox{\begin{subfigure}{0.54\textwidth}
  \centering
    \begin{dependency}[text only label, label style={above}, font=\small]
    \begin{deptext}[column sep=.4em,ampersand replacement=\^]
...
\cprotect\caption{{\scriptsize\verb|newsgroup-groups.google.com_GuildWars_086f0f64ab633ab3_ENG_20041111_173500-0051|} (\verb|UD_English-EWT|), containing a null node (\textbf{E9.1}) and
case information (nmod:on).}
\label{fig:example_ellipsis}
\end{figure*}

\begin{figure*}[ht]
\fbox{\begin{subfigure}{0.58\textwidth}
    \centering
    \begin{dependency}[text only label, label style={above}, font=\small]
...
\end{subfigure}}
\fbox{\begin{subfigure}{0.41\textwidth}
...
The priority order is: \verb|parataxis, conj, advcl, xcomp|
...
\begin{tabular}{lccc}
\hline
& \multirow{2}{39mm}{\bf TUPA {\small(official)}} & \multirow{2}{39mm}{\bf TUPA {\small(unofficial)}}
& \multirow{2}{39mm}{\bf UDPipe {\small(baseline)}} \\\\
\hline
...
\hline
& \multicolumn{3}{c|}{Enhanced LAS} & \multirow{2}{*}{\% Enhanced} \\
