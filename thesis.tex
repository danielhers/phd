...
\pgfplotstableread{
category	Single	UCCA+AMR	UCCA+UD	UCCA+DM	UCCA+DM+UD	UCCA+AMR+UD	UCCA+AMR+DM	UCCA+AMR+DM+UD
...
\begin{figure}
    ...
    yticklabels=none,
    tickwidth=0pt,
    legend style={at={(axis cs:-.5,100)},anchor=north east,font=\tiny},
    ...
    \addplot[fill=green]table[x expr=\coordindex,meta=model,y=Single]{\englishwiki};
    \legend{Single}
    \end{axis}
    \end{tikzpicture}
