...
which uses syntactic analysis in the form of a CCG derivation
to perform meaning analysis based on
Discourse Representation Theory \cite[DRT;][]{kamp2013discourse}.

DRT is a general framework for representing the meaning of sentences and discourse,
...
truly scalable learning of meaning and inference requires an inductive bias
on the compositional structure of language. Without this bias,
learned require an unbounded number of training instances in order to properly
learn to generalize to the flexible structures exhibited by natural language.
