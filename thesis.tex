...
\begin{figure}
    ...
    yticklabels=none,
    tickwidth=0pt,
    legend style={at={(axis cs:-1,100)},anchor=north east,font=\tiny},
    ...
    \legend{Participant,Center,Adverbial,Elaborator,Parallel Scene,Connector,Relator,State,Function,Process,Linker}
    \end{axis}
    \end{tikzpicture}
