...
parataxis	100	100	100	100	100	100	100	100
cop	100	100	100	100	100	100	100	100
ccomp	86	86	86	86	86	86	86	86
xcomp	100	100	100	100	100	100	100	100
}\englishwikiud
\pgfplotstableread{
case	78	84
compound	22	32
...
\begin{subfigure}{\textwidth}
    ...
    yticklabels=none,
    tickwidth=0pt,
    legend style={at={(axis cs:-.5,100)},anchor=south west,font=\tiny,draw=none,legend columns=-1},
    ...
    \legend{Single,UCCA+AMR,UCCA+UD,UCCA+DM,UCCA+DM+UD,UCCA+AMR+UD,UCCA+AMR+DM,UCCA+AMR+DM+UD}
    \end{axis}
    \end{tikzpicture}
    \caption{English Wiki, by UCCA categories}
\end{subfigure}
\begin{figure}
\begin{subfigure}{\textwidth}
    \begin{tikzpicture}
    ...
    \legend{Single,UCCA+UD}
    \end{axis}
    \end{tikzpicture}
    \caption{French 20K, by UCCA categories}
\end{subfigure}
\begin{subfigure}{\textwidth}
    \begin{tikzpicture}
    \begin{axis}[
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{German 20K, by UCCA categories}
\end{subfigure}
