...
The following example shows {\color{blue}syntactic}/{\color{red}semantic} bi-lexical dependencies for the sentence ``While driving, I listen to podcasts''.
    ...
    \begin{dependency}[line width=1.5pt]
        ...
        \end{deptext}
        \depedge[edge below,draw=red,edge unit distance=3ex]{1}{2}{ARG2}
        \depedge[edge below,draw=red,edge unit distance=3ex]{5}{4}{ARG1}
        \depedge[edge below,draw=red,edge unit distance=2ex, edge end x offset=-2pt]{1}{5}{ARG1}
        \deproot[edge below,draw=red,edge unit distance=3ex]{5}{top}
        \depedge[edge below,draw=red,edge unit distance=4ex, edge start x offset=-1pt, edge end x offset=3pt]{5}{7}{ARG2}
        \depedge[edge below,draw=red,edge unit distance=3ex, edge end x offset=5pt]{6}{5}{ARG1}
        \depedge[edge below,draw=red,edge unit distance=3ex]{6}{7}{ARG2}
        \depedge[draw=blue,edge unit distance=3ex]{2}{1}{case}
        \depedge[draw=blue,edge unit distance=3ex]{2}{3}{punct}
        \depedge[draw=blue,edge unit distance=3ex]{5}{4}{nsubj}
        \depedge[draw=blue,edge unit distance=3ex, edge end x offset=-2pt]{5}{2}{obl}
        \depedge[draw=blue,edge unit distance=3ex]{7}{6}{case}
        \deproot[draw=blue,edge unit distance=4ex]{5}{root}
        \depedge[draw=blue,edge unit distance=4ex]{5}{7}{obl}
    \end{dependency}
    \end{adjustbox}
            ...
            \begin{tikzpicture}[level distance=7mm, sibling distance=6mm,
                ...
                \end{scope}
                  ...
                  \begin{scope}[dashed,thick]
                    \draw[red] (After u) to[out=-45,in=135] (ahrei d);
                    \draw[green] (graduation u) to[out=-90,in=100] (John siyem et halimudim d);
                    \draw[blue] (John u) -- (John d);
...
\end{tabular}
\caption{UCCA English data statistics.}\label{tab:data_english}
\end{table}
