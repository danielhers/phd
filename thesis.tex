...
(Universal Dependencies, for example, is a recent multilingual bi-lexical
...
Transition-based are also called \textit{shift-reduce} parsers, as
...
\citep{dyer2015transition,ballesteros2015improved,kiperwasser2016simple,andor2016globally}, and has also demonstrated
...
Some transition-based AMR parsers
have a transition system tailored to AMR parsing \citet{zhou2016amr,damonte-17,D17-1130}.

The parser presented here, TUPA, combines techniques from transition-based discontiguous constituency parsing \cite{maier2015discontinuous}
