...
While divergences between schemes may limit the gain from sharing,
...
and addressed the generality question effectively to allow multitask learning.
...
In ongoing work, I take the comparison to Universal Dependencies further,
looking at ways to complement syntax with \textit{lexical} semantics to make up for differences.
