...
\begin{figure}[ht]\small
  ...
  \parbox{.03\textwidth}{\caption{}\label{fig:implicit}}
  \parbox{.8\textwidth}{
  ...
  child {node (1_2) [circle] {}
    {
    child {node (1_16) [word] {\textbf{IMPLICIT}}  edge from parent node[auto]  {A}}
  ...
  child {node (1_4) [circle] {}
    ...
    child {node (1_8) [circle] {}
      {
      child {node (1_9) [word] {with}  edge from parent node[auto]  {R}}
      child {node (1_10) [circle] {}
        {
        child {node (1_15) [word] {my}  edge from parent node[auto]  {S}}
      ...
      child {node (1_12) [circle] {}
        {
        child {node (1_13) [word] {to}  edge from parent node[auto]  {F}}
...
\end{tikzpicture}
  ...
  \end{subfigure}
  \begin{subfigure}{\textwidth}
  \parbox{.03\textwidth}{\caption{}\label{fig:remote}}
  \parbox{.8\textwidth}{
  \begin{tikzpicture}[->,level distance=1cm,
  ...
  child {node (1_2) [circle] {}
    {
    child {node (1_8) [word] {Everything}  edge from parent node[auto]  {A}}
  ...
  child {node (1_4) [circle] {}
    {
    child {node (1_6) [word] {cooked}  edge from parent node[auto]  {P}}
...
\end{tikzpicture}
  ...
  \end{subfigure}
  \begin{subfigure}{\textwidth}
  \parbox{.03\textwidth}{\caption{}\label{fig:home}}
  \parbox{.8\textwidth}{
  ...
  \end{subfigure}
  \begin{subfigure}{\textwidth}
  \parbox{.03\textwidth}{\caption{}\label{fig:gave}}
  \parbox{.8\textwidth}{
  \begin{tikzpicture}[level distance=12mm, ->,
      every node/.append style={midway}]
    \node (ROOT) [fill=black, circle] {}
  ...
  \end{subfigure}
  \begin{subfigure}{\textwidth}
  \parbox{.03\textwidth}{\caption{}\label{fig:shower}}
  \parbox{.8\textwidth}{
  \begin{tikzpicture}[level distance=12mm, ->,
      every node/.append style={midway}]
    \node (ROOT) [fill=black, circle] {}
      child {node (John) {John} edge from parent node[left] {\scriptsize $A$}}
      child {node {thought} edge from parent node[left] {\scriptsize $P$}}
      child {node (totakeaquickshower) [fill=black, circle] {}
      {
        child {node {about} edge from parent node[left] {\scriptsize $R$}}
        child {node [fill=black, circle] {}
        {
          child {node {taking} edge from parent node[left] {\scriptsize $C$}}
  ...
  \caption{\label{fig:examples}
    UCCA examples.
    (\subref{fig:implicit}) includes an implicit node, since the subject of ``Glad'' is omitted.
    (\subref{fig:remote}) includes a remote edge (dashed),
    ...
    (\subref{fig:shower}) includes both a remote edge and a discontinuous unit (``taking a ... shower'').
