...
\begin{figure}[ht!]
  ...
  \tikzstyle{vertex}=[circle,draw=black,minimum size=34pt]
  ...
  \begin{tikzpicture}[level distance=12mm, ->,
      every node/.append style={midway}]
    \node (ROOT) [draw=black, circle] {}
      child {node [draw=black, circle] {}
      {
        child {node {John} edge from parent node[left] {}}
        child {node {and} edge from parent node[left] {}}
        child {node {Mary} edge from parent node[left] {}}
      } edge from parent node[left] {}}
      child {node {went} edge from parent node[left] {}}
      child {node {home} edge from parent node[left] {}}
      ;
  \end{tikzpicture}
  \caption{}\label{fig:recnn}
  \end{subfigure}
