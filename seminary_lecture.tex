...
\begin{tikzpicture}[level distance=16mm, sibling distance=28mm, ->,
  ...
  \tikzstyle{word} = [font=\rmfamily,color=black]
    \node (ROOT) [fill=blue, circle] {}
      ...
      ;
    \draw[bend left,dashed,->,visible on=<1>] (abouttakingashortbreak) to node [auto] {\scriptsize A} (They);
    \draw[bend left,dashed,->,orange,very thick,visible on=<2->] (abouttakingashortbreak) to node [auto] {\scriptsize A} (They);
    \draw[bend left,->,visible on=<-2>] (abouttakingashortbreak) to node [auto] {\scriptsize D} (short);
    \draw[bend left,->,red,very thick,visible on=<3>] (abouttakingashortbreak) to node [auto] {\scriptsize D} (short);
...
\begin{tabular}{l|r|rrr|r}
    ...
    \# {\color{blue} nodes}&201,461&16,725&17,227&189,625&68,047 \\
    \% {\color{red}discontinuous}&0.53&0.90&1.38&2.43&1.03 \\
    \% {\color{orange}reentrant}&8.34&7.22&6.62&2.38&2.86 \\
    \hline
    \# edges&347,631&28,560&29,329&322,611&110,393 \\
    \% primary&98.35&97.79&98.06&98.34&97.88 \\
    \% remote&1.65&2.21&1.94&1.66&2.12
\end{tabular}
\end{frame}
...
\begin{tikzpicture}[xscale=1.4,every node/.append style={font=\rmfamily,
    ...
    \begin{scope}[xstep=1,ystep=.5,color=red,line width=1pt]
      ...
      \only<4>     \draw (4,   0) grid (5,.5);
      \only<9>     \draw (5,   0) grid (6,.5);
      \only<14>    \draw (6,   0) grid (7,.5);
      \only<22>    \draw (8,   0) grid (9,.5);
      \only<25>    \draw (7,   0) grid (8,.5);
    ...
    \begin{scope}[xstep=1,ystep=.5,color=gray]
      ...
      \only<-2,4-6>              \draw (4,   0) grid (10,.5);
      \only<3,5-7,9-10>          \draw (5,   0) grid (10,.5);
      \only<8,11-12,14-15>       \draw (6,   0) grid (10,.5);
      \only<13,16-17,25-28>      \draw (7,   0) grid (10,.5);
      \only<18-20,22-24,29-30>   \draw (8,   0) grid (10,.5);
      \only<21,31>               \draw (9,   0) grid (10,.5);
    \end{scope}
    ...
    \only<9-10>     \node[fill=blue,  circle] at (5.3,.25) {};
    \only<14-15>    \node[fill=red,   circle] at (6.3,.25) {};
    \only<22-30>    \node[fill=red,   circle] at (8.3,.25) {};
    ...
    \only<4-6>      \node at (4,.2) {\small They};
    \only<25-28>    \node at (7,.2) {\small They};
    \only<-2>       \node at (4,.2) {\small thought};
    \only<-7>       \node at (5,.2) {\small about};
    \only<-12>      \node at (6,.2) {\small taking};
    \only<-17>      \node at (7,.2) {\small a};
    \only<-20>      \node at (8,.2) {\small short};
    \only<-31>      \node at (9,.2) {\small break};
\end{tikzpicture}
\vfill
\fbox{
\begin{tikzpicture}[level distance=15mm, sibling distance=25mm, ->,
    ...
    \node(ROOT)[fill=black, circle, visible on=<1->] at (3,0) {}
      ...
      {
        child [visible on=<9->] {node (to) {about} edge from parent node [left] {R}}
        child [visible on=<14->] {node (takingabreak) [fill=red, circle] {}
        {
          child [visible on=<14->] {node (take) {taking} edge from parent node [right] {C}}
    ...
    \draw[bend left, visible on=<23->] (abouttakingashortbreak) to node [auto] {\scriptsize D} (short);
\end{tikzpicture}}
\end{frame}
...
\begin{tikzpicture}[level distance=15mm, sibling distance=2cm, ->,
    ...
    \node(ROOT)[fill=black, circle] at (3,0) {}
      ...
      child {node (abouttakingashortbreak) [fill=blue, circle] {} 
      { 
        child {node (to) {about} edge from parent node [left] {R}}
        child {node (takingabreak) [fill=red, circle] {}
        {
          child {node (take) {taking} edge from parent node [right] {C}}      
...
\begin{tikzpicture}[every node/.append style={font=\rmfamily}]
    \node[anchor=west,style={font=\sffamily}] at (-1.2,.25){stack};
    \draw[xstep=1cm,ystep=5mm,color=gray] (-.01,0) grid (4,.5);
...
\vspace{1cm}
\begin{tikzpicture}[every node/.append style={font=\rmfamily}]
    \node[anchor=west,style={font=\sffamily}] at (3.8,.25){buffer};
    \draw[xstep=1cm,ystep=5mm,color=gray] (5,0) grid (9,.5);
    \node[fill=red, circle] at (5.5,.25) {};
    \node[anchor=west] at (6,.25) {\small a};
    \node[anchor=west] at (7,.25) {\small short};
    \node[anchor=west] at (8,.25) {\small break};
\end{tikzpicture}
\end{minipage}
...
\begin{tikzpicture}[level distance=1cm, sibling distance=1cm, ->,
    ...
    \node(ROOT)[fill=black, circle, visible on=<2->] at (3,0) {}
      ...
      child {node (abouttakingashortbreak) [fill=blue, circle] {}
      {
        ...
        child {node (takingabreak) [fill=red, circle] {}
        {
          child {node {taking} edge from parent node [right] {C}}
...
\begin{center}
    \begin{dependency}
    \begin{deptext}[column sep=1.5em,ampersand replacement=\^,font=\rmfamily]
	They \^ thought \^ to \^ take \^ a \^ short \^ break \\
    \end{deptext}
    \depedge{2}{1}{A}
    \depedge{2}{4}{A}
    ...
    \begin{tikzpicture}[level distance=15mm, sibling distance=15mm, ->,
      ...
      \node (ROOT_) at (7,0) [circle] {}
        ...
        child {node (moved) [circle,xshift=3mm,yshift=-7mm] {}
        {
          ...
          child {node [word] {moved} edge from parent node[left] {P}}
          child[red] {node [word] {about} edge from parent node[left] {R}}
          child[red] {node (Copenhagen_) [word] {Copenhagen} edge from parent node[right] {A}}
        } edge from parent node[right] {H} }
        ;
      \draw[bend left,dashed,->] (graduation_) to node [auto] {\scriptsize A} (John_);
...
\begin{tikzpicture}[every node/.append style={font=\rmfamily}, circle]
    ...
    \node[fill=black] at (1.5,.25) {};
    \draw[xstep=12.5mm,ystep=5mm,color=gray] (2.5,0) grid (10,.5);
    \node[anchor=west,style={font=\sffamily}] at (2.4,.75) {buffer};
    \node[anchor=west] at (2.5,.25) {\small After};
    \node[anchor=west] at (3.75,.25) {\small gradu.};
    \node[anchor=west] at (5,.25) {\small John};
    \node[anchor=west] at (6.25,.25) {\small moved};
    \node[anchor=west] at (7.5,.25) {\small to};
    \node[anchor=west] at (8.75,.25) {\small Copenhagen};
\end{tikzpicture}
...
\vspace{-2.5mm}
    \begin{center}\scalebox{.3}{\Huge
       ...
       \foreach \i/\word in {-4/{After},4/{graduation},17/{about},25/{Copenhagen}} {
