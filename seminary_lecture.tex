...
\begin{center}
\onslide<1>{\fbox{After graduation, John moved to Copenhagen}}

\onslide<1>{$\downarrow$}

\only<1>{\fbox{\heb{אחרי שג'ון סיים את הלימודים, הוא עבר לקופנהגן}}}
\only<2>{\fbox{\heb{אחרי ש\underline{\heb{ג'ון}} סיים את הלימודים, הוא עבר ל\underline{\heb{קופנהגן}}}}}
\end{center}
...
\hspace{28mm} $\uparrow$ \hspace{48mm} $\uparrow$
