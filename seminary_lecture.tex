...
\begin{center}
    \fbox{\textrm{rest}} = \fbox{\textrm{take a break}}
    
    \vspace{1cm}
    
    \fbox{\textrm{graduation}} = \fbox{\heb{סיים את הלימודים}}
\end{center}
\end{frame}
...
\begin{adjustbox}{center}
            \begin{tikzpicture}[level distance=7mm, sibling distance=6mm,
                ...
                \end{scope}
                \begin{scope}[xshift=23mm,yshift=-58mm,grow'=up,level distance=9mm,
                ...
                \begin{scope}[dashed,thick]
                  ...
                  \draw[DarkGreen] (graduation u) -- (halimudim d);
                  \draw[DarkBlue] (John u) -- (John d);
                  \draw[orange] (moved u) to[out=-30,in=90] (avar d);
                  \draw[magenta] (to Copenhagen u) to[out=-90,in=110] (lecopenhagen d);
                \end{scope}
            \end{tikzpicture}
\end{adjustbox}
\end{frame}
...
\hspace*{1cm}
  ...
  \tikzstyle{word} = [font=\rmfamily,color=black]
    \node (ROOT) [fill=blue, circle] {}
      child {node (They) [word] {They} edge from parent node[left] {\scriptsize $A$}}
      child {node [word] {need} edge from parent node[left] {\scriptsize $P$}}
      child {node (totakealongbath) [fill=blue, circle] {}
      {
        ...
        child {node (takealongbath) [fill=blue, circle] {}
        {
          child {node (takeabath) [fill=blue, circle] {}
          {
            ...
            child {node [word] {break} edge from parent node[right] {\scriptsize $C$}}
...
\begin{tikzpicture}[level distance=15mm, sibling distance=2cm, ->,
    ...
    \node(ROOT)[fill=black, circle, visible on=<1->] at (3,0) {}
      child [visible on=<2->,alt=<2>{draw=red}{}] {node (They) {They} edge from parent node [left] {\scriptsize $A$}}
      child [visible on=<5->,alt=<5>{draw=red}{}] {node (need) {need} edge from parent node [left] {\scriptsize $P$}}
      child [visible on=<9->] {node (totakealongbath) [fill=blue, circle] {}
      {
        ...
        child [visible on=<14->] {node (takeabath) [fill=red, circle] {}
        {
          ...
          child [visible on=<32->,alt=<32>{draw=red}{}] {node (break) {break} edge from parent node [right] {\scriptsize $C$}}
...
\begin{tikzpicture}[level distance=15mm, sibling distance=2cm, ->,
    ...
    \node(ROOT)[fill=black, circle] at (3,0) {}
      child {node (They) {They} edge from parent node [left] {\scriptsize $A$}}
      child {node (need) {need} edge from parent node [left] {\scriptsize $P$}}
      child {node (totakealongbath) [fill=blue, circle] {} 
      { 
        ...
        child {node (takeabath) [fill=red, circle] {}
        {
          ...
          child {node (break) {break} edge from parent node [right] {\scriptsize $C$}}  
        } edge from parent [draw=none]}
      } edge from parent [draw=none]}
      ;
...
\begin{tikzpicture}[level distance=1cm, sibling distance=1cm, ->,
    ...
    \node(ROOT)[fill=black, circle, visible on=<2->] at (3,0) {}
      child {node (They) {They} edge from parent node [left] {\scriptsize $A$}}
      child {node {need} edge from parent node [left] {\scriptsize $P$}}
      child {node (totakealongbath) [fill=blue, circle] {}
      {
        child {node {to} edge from parent node [left] {\scriptsize $F$}}
        child {node (takeabath) [fill=red, circle] {}
        {
          ...
          child [opacity=0] {node {break} edge from parent node [right] {\scriptsize $C$}}
        } edge from parent [draw=none]}
      } edge from parent [draw=none]}
      ;
\end{tikzpicture}
