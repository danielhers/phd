...
\def\convertedudgraduation{
  \begin{tikzpicture}[level distance=15mm, ->, draw=DarkBlue,
...
\begin{minipage}{.45\textwidth}
  ...
  \centering
  \scalebox{.6}{
  \begin{tikzpicture}[level distance=16mm, ->, draw=DarkGreen,
      every node/.append style={sloped,anchor=south,auto=false,font=\scriptsize},
  ...
  \vspace{5mm}
  \scalebox{.6}{
  \begin{tikzpicture}[level distance=14mm, ->, draw=DarkRed,
      every node/.append style={sloped,anchor=south,auto=false,font=\scriptsize},
...
\begin{minipage}{.5\textwidth}
\scalebox{.7}{
\begin{tikzpicture}[level distance=17mm, sibling distance=25mm, ->, draw=Indigo]
...
\begin{flushright}
\scalebox{.9}{
\begin{tikzpicture}[level distance=15mm, sibling distance=21mm, ->, draw=Indigo]
    \node[anchor=west,font=\sffamily\LARGE,Indigo] at (-4,0) {UCCA};
    \node (ROOT) [fill=Indigo, circle] {}
      child {node (After) {After} edge from parent node[left] {L\;}}
      child {node (graduation) [fill=Indigo, circle] {}
...
\begin{frame}
\frametitle{Multi-word Expressions, Linkage}

\begin{flushright}
\scalebox{.9}{
\begin{tikzpicture}[level distance=15mm, sibling distance=28mm, ->, draw=Indigo,
...
\only<2>{
  ...
  \scalebox{.9}{
  \begin{tikzpicture}[level distance=17mm, sibling distance=28mm, ->, draw=DarkBlue,
      every node/.append style={sloped,anchor=south,auto=false,font=\scriptsize},
...
\begin{minipage}{.5\textwidth}
    ...
    \begin{deptext}[column sep=0,ampersand replacement=\^]
    After \^ graduation \^ , \^ John \^ moved \^ to \^ Copenhagen \\
    \end{deptext}
