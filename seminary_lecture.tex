...
\hspace*{1cm}
  ...
  \tikzstyle{word} = [font=\rmfamily,color=black]
    \node (ROOT) [fill=blue, circle] {}
      ...
      ;
    \draw[bend left,dashed,->,orange,very thick] (takeashortbreak) to node [auto] {\scriptsize A} (They);
    \draw[bend left,->,red,very thick] (ROOT) to node [auto] {\scriptsize D} (short);
