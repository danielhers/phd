...
\only<4>{
  Sequence-to-sequence works, but lacks inductive bias.
...
\begin{adjustbox}{center}
  \includegraphics[width=.85\textwidth]{crosslinguistic.png}
\end{adjustbox}
\end{frame}

\begin{frame}
\frametitle{Universal Conceptual Cognitive Annotation (UCCA)}
Rapid and intuitive annotation interface, usable by non-experts.
...
Applications:
\begin{itemize}
  \item Semantics-based \textbf{evaluation} of
  \begin{itemize}
  ...
  \end{itemize}
  \item<2> Sentence splitting for text simplification \cite{sulem2018simple}.
\end{itemize}
