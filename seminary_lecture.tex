...
\hspace*{1cm}
  ...
  \tikzstyle{word} = [font=\rmfamily,color=black]
    \node (ROOT) [fill=blue, circle] {}
      ...
      ;
    \draw[bend left,dashed,->,orange,very thick] (totakealongbath) to node [auto] {\scriptsize A} (They);
    \draw[bend left,->,red,very thick] (takealongbath) to node [auto] {\scriptsize D} (short);
...
\begin{tikzpicture}[level distance=15mm, sibling distance=2cm, ->,
    ...
    \draw[bend left,dashed, visible on=<12->,alt=<12>{draw=red}{}] (totakealongbath) to node [auto] {\scriptsize A} (They);
    \draw[bend left, visible on=<23->] (totakealongbath) to node [auto] {\scriptsize D} (short);
\end{tikzpicture}}
\end{frame}
...
\begin{tikzpicture}[level distance=15mm, sibling distance=2cm, ->,
    ...
    \draw[bend left,dashed] (totakealongbath) to node [auto] {\scriptsize A} (They);
    \draw[bend left] (totakealongbath) to node [auto] {\scriptsize D} (short);
\end{tikzpicture}}
\[\Downarrow\]
\begin{flushleft}
\footnotesize
