...
\begin{adjustbox}{center}
            \begin{tikzpicture}[level distance=7mm, sibling distance=6mm,
                ...
                \end{scope}
                \begin{scope}[xshift=26mm,yshift=-58mm,grow'=up,level distance=9mm,
                ...
                \Tree [.\node [circle] (rootd) {};
                  ...
                  [.\node [circle,xshift=-5mm] (John siyem et halimudim d) {};
                    ...
                    \edge node[auto=left]{D}; \node (siyem d) {\heb{סיים}};
                    \edge node[auto=right]{A}; \node (John d) {\heb{שג'ון}};
                  ]
                  \edge node [auto=right]{L}; \node (ahrei d) {\heb{אחרי}};
                ]
                \end{scope}
                \begin{scope}[dashed]
                  \draw[DarkRed] (After u) to[out=-90,in=90] (ahrei d);
                  \draw[DarkGreen] (graduation u) -- (halimudim d);
                  \draw[DarkBlue] (John u) -- (John d);
                  \draw[orange] (moved u) -- (avar d);
                  \draw[magenta] (to Copenhagen u) -- (lecopenhagen d);
                \end{scope}
            \end{tikzpicture}
\end{adjustbox}
\end{frame}
