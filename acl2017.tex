...
\chapter{A Transition-Based Directed Acyclic Graph Parser for UCCA (Published in ACL 2017)}\label{acl2017}
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[level distance=12mm, ->,
    ...
    \node (ROOT) [circle] {}
      ...
      ;
  \end{tikzpicture}
  }\caption{}\label{fig:homea}
  \end{subfigure}
  \begin{subfigure}{.1\textwidth}
  \begin{adjustbox}{width=\textwidth,margin=1pt,frame}
  \begin{tabular}{ll}
	  P & process \\
	  A & participant \\
	  H & linked scene \\
